...
<b-tab title="Бонусные оценки" style="display:none;" id="bonuse">
  <h3>Бонусные оценки</h3>
...
@foreach($students as $i => $student)
      <tr>
        ...
        <? $has = 1;?>
        <td><div
          data-hover="row_s{{$student->id}}" style="background:{{$date->color_rgba}};" class="pointer"
