...
<div class="options">
  ...
  <div class="row">
    ...
    <div class="card-deck  mb-3">
      ...
      <div class="card mb-6 shadow-sm" style="margin-left: 30px !important;">
        <div class="card-header bg-secondary text-white">
  ...
  <div class="row text-area-block">
    ...
    <div class="card-deck mb-3" style="margin-left: 30px;">
      <div class="card mb-4 shadow-sm" >
        <div class="card-header bg-secondary text-white">
...
<button class="btn btn-success" id="save_task"><i class="fas fa-save"></i> Сохранить</button>
